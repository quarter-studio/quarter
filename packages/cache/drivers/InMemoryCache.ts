...
export default class InMemoryCache implements Cache {
  ...
  public async get<Class>(key: string, expiration: number | Date, resolve: () => Promise<Class>): Promise<Class> {
  ...
  public async set(key: string, expiration: number | Date, value: any): Promise<void> {
    this.data.set(key, {
